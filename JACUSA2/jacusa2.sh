...
## JACUSA2
wget -q https://github.com/dieterich-lab/JACUSA2/releases/download/v2.0.2-RC/JACUSA_v2.0.2-RC.jar -O jacusa2.jar
...
## JACUSA2helper
wget https://bioconductor.org/packages/3.16/data/annotation/src/contrib/BSgenome.Hsapiens.NCBI.GRCh38_1.3.1000.tar.gz
wget https://github.com/dieterich-lab/JACUSA2helper/releases/download/v1.99-9600/JACUSA2helper_1.9.9.9600.tar.gz
